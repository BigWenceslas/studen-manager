...
@section('title')
    {{ config('app.name') }} | @lang('Liste filieres')
@endsection
                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap py-5">
                        <div class="card-title">
                            <h3 class="card-label">@lang('Liste des Filieres')

                            </h3>
                        </div>
                        <div class="card-toolbar">
                            <!--begin::Button-->
                            <a href="{{ route('filieres-make') }}" class="btn btn-primary font-weight-bolder">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover datatable datatable-User">
                                ...
                                <tbody>
                                    @foreach ($filieres as $niv)
                                        <tr data-entry-id="{{ $niv->id }}">
                                            <td>{{ $niv->id }}</td>
                                            <td>{{ $niv->intitule }}</td>
                                            <td>{{ $niv->description }}</td>
                                            <td>
                                                <form method="POST" style="display: inline-block"
                                                      action="{{ route('filieres-delete', ['id' => $niv->id]) }}"
                                                      accept-charset="UTF-8" class="delete">
                                                    @method("DELETE")
                                                    @csrf
                                                    <button type="submit" class="btn btn-round" title="Supprimer">
