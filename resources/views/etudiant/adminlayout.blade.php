			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						...
						<div class="text-muted mt-1">@foreach(auth()->user()->roles()->pluck('name') as $role)
				...
				<div class="navi navi-spacer-x-0 p-0">
					<!--begin::Item-->
					<a href="{{route('profil',['id'=>auth()->user()->id])}}" class="navi-item">
						<div class="navi-link">
							...
							<div class="navi-text">
								<div class="font-weight-bold">@lang('Profile')</div>
								<div class="text-muted">@lang('Account settings and more')
                            </div>
							</div>
						</div>
					</a>
				...
				<div>
					<!--begin:Heading-->
					<h5 class="mb-5">@lang('Recent Notifications')</h5>
					<!--end:Heading-->
					<!--begin::Item-->
